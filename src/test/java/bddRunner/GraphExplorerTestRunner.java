...
@CucumberOptions(
        features = {"src/test/resources/FeatureFile/SalesForceXfilesPro/GraphExplorer.feature"},
        glue = {"pageHelper"},
        plugin = {
                "com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:"
        },
        tags = "@GraphExplorer-01-10-2025")

public class GraphExplorerTestRunner extends AbstractTestNGCucumberTests {
