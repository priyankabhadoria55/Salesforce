...
@CucumberOptions(
        features = {"src/test/resources/FeatureFile/SalesForceXfilesPro/DeleteModule.feature"},
        glue = {"pageHelper"},
        plugin = {
                "pretty",
        ...
        tags = "@XfileUploadDelete")

public class DeleteModuleTestRunner extends AbstractTestNGCucumberTests {
