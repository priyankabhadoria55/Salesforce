...
@CucumberOptions(
        features = {"src/test/resources/FeatureFile/SalesForceXfilesPro/StorageSetup.feature"},
        glue = {"pageHelper"},
        plugin = {
                "pretty",
        ...
        tags = "@StorageSetupStep")

public class StorageSetupTestRunner extends AbstractTestNGCucumberTests {
